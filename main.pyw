...
from viper_ui_setup_windows import SetupWindowMixin
...
class ViperDashboard(DashboardTabMixin, DeviceToolsMixin, DoorbellTabMixin, PromptEditorMixin, SpeakerManagementMixin, SetupStatusMixin, SetupWindowMixin, TtsSettingsMixin, FridgeTabMixin, HvacTabMixin, VacuumTabMixin, DiagnosticsTabMixin, AppLifecycleMixin, wx.Frame):
    def __init__(self):
    ...
    def _create_home_assistant_first_run_assistant_dialog(self):
        return HomeAssistantFirstRunAssistantDialog(self)

    def _create_home_assistant_setup_dialog(self, *, use_env_prefill=True):
        return HomeAssistantSetupDialog(self, use_env_prefill=use_env_prefill)
