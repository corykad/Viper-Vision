...
class ViperDashboard(DashboardTabMixin, DoorbellTabMixin, PromptEditorMixin, SpeakerManagementMixin, FridgeTabMixin, HvacTabMixin, VacuumTabMixin, DiagnosticsTabMixin, wx.Frame):
    def __init__(self):
