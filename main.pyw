...
class ViperDashboard(DashboardTabMixin, DoorbellTabMixin, PromptEditorMixin, SpeakerManagementMixin, TtsSettingsMixin, FridgeTabMixin, HvacTabMixin, VacuumTabMixin, DiagnosticsTabMixin, wx.Frame):
    def __init__(self):
